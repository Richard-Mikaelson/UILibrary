...
local Luna = { Folder = "Luna", Options = {}, ThemeGradient = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(24, 24, 24)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(24, 24, 24)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(24, 24, 24))} }
...
function Luna:CreateWindow(WindowSettings)
	...
	local Window = { Bind = Enum.KeyCode.LeftAlt, CurrentTab = nil, State = true, Size = false, Settings = nil }
